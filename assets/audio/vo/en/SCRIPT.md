...
Each line is recorded as `res://assets/audio/vo/en/<key>.ogg`. The wording must
...
| `l2_hard_soil_prompt` | The soil around the plant is hard and dry. What should you use to loosen the soil? |
| `l2_dead_leaves_prompt` | The plant has dead, brown leaves. What tool can help remove them? |
